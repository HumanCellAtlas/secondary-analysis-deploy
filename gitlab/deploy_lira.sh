...
echo "SS2_SE_ANALYSIS_WDLS=${SS2_SE_ANALYSIS_WDLS}"
echo "SS2_SE_OPTIONS_LINK=${SS2_SE_OPTIONS_LINK}"
echo "SS2_SE_SUBSCRIPTION_ID=${SS2_SE_SUBSCRIPTION_ID}"
echo "SS2_SE_WDL_STATIC_INPUTS_LINK=${SS2_SE_WDL_STATIC_INPUTS_LINK}"
echo "SS2_SE_WDL_LINK=${SS2_SE_WDL_LINK}"
echo "SS2_SE_WORKFLOW_NAME=${SS2_SE_WORKFLOW_NAME}"
echo "SS2_SE_VERSION=${SS2_SE_VERSION}"
