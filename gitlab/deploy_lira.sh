...
echo "OPTIMUS_MOUSE_PREFIX=${OPTIMUS_MOUSE_PREFIX}"
echo "OPTIMUS_MOUSE_ANALYSIS_WDLS=${OPTIMUS_MOUSE_ANALYSIS_WDLS}"
echo "OPTIMUS_MOUSE_OPTIONS_LINK=${OPTIMUS_MOUSE_OPTIONS_LINK}"
echo "OPTIMUS_MOUSE_WDL_STATIC_INPUTS_LINK=${PIPELINE_TOOLS_PREFIX}/adapter_pipelines/Optimus_mouse/adapter_example_static.json"
echo "OPTIMUS_MOUSE_WDL_LINK=${OPTIMUS_MOUSE_WDL_LINK}"
echo "OPTIMUS_MOUSE_WORKFLOW_NAME=${OPTIMUS_MOUSE_WORKFLOW_NAME}"
